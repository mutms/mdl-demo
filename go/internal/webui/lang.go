...
var messages = map[string]map[string]string{
	"cs": {
		...
		"— recommendations":                                        "– doporučení",
		"My recommendations":                                       "Moje doporučení",
		"Projects and companies I like.":                           "Projekty a firmy, které mám rád.",
		"Think I'd like your project? Get in touch through MuTMS.": "Myslíte, že by se mi váš projekt líbil? Ozvěte se přes MuTMS.",
		"Public":   "Veřejné",
		"starting": "spouští se",
		"Off":      "Vypnuto",
	...
	"de": {
		...
		"Projects and companies I like.":                           "Projekte und Firmen, die ich mag.",
		"Think I'd like your project? Get in touch through MuTMS.": "Denkst du, dein Projekt gefällt mir? Melde dich über MuTMS.",
		"Public":   "Öffentlich",
