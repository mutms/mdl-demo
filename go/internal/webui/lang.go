...
var messages = map[string]map[string]string{
	"cs": {
		...
		"Adding a plugin runs its code on this throwaway demo.":                                   "Přidání pluginu spustí jeho kód na těchto odhoditelných demo stránkách.",
		"If things break, reset the site. If it gets compromised, delete the container entirely.": "Když se něco pokazí, smažte stránky. Při napadení smažte celý kontejner.",
		"Version":                              "Verze",
		...
		"CAUTION": "POZOR",
		"A backup from another container carries its own database and files. Restoring it runs that content on this throwaway demo.": "Záloha z jiného kontejneru s sebou nese vlastní databázi a soubory. Její obnovení spustí tento obsah na těchto odhoditelných demo stránkách.",
		"Backups":                         "Zálohy",
		"File":                            "Soubor",
		"Created":                         "Vytvořeno",
		"Size":                            "Velikost",
	...
	"de": {
		...
		"Adding a plugin runs its code on this throwaway demo.":                                   "Ein Plugin hinzuzufügen führt seinen Code auf dieser Wegwerf-Demo aus.",
		"If things break, reset the site. If it gets compromised, delete the container entirely.": "Geht etwas kaputt, setzen Sie die Website zurück. Bei einer Kompromittierung löschen Sie den Container ganz.",
		"Version":                              "Version",
		...
		"CAUTION": "ACHTUNG",
		"A backup from another container carries its own database and files. Restoring it runs that content on this throwaway demo.": "Eine Sicherung aus einem anderen Container bringt ihre eigene Datenbank und Dateien mit. Beim Wiederherstellen läuft dieser Inhalt auf dieser Wegwerf-Demo.",
		"Backups":                         "Sicherungen",
		"File":                            "Datei",
		"Created":                         "Erstellt",
		"Size":                            "Größe",
