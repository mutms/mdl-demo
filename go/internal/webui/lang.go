...
var messages = map[string]map[string]string{
	"cs": {
		...
		"Add plugin":              "Přidat plugin",
		"tag":                     "tag",
		"adding plugin":           "přidává se plugin",
		"Adding a plugin runs its code on this throwaway demo — do it only with code you are willing to run.": "Přidání pluginu spustí jeho kód na této dočasné ukázce – dělejte to jen s kódem, kterému důvěřujete.",
		"Version":                              "Verze",
	...
	"de": {
		...
		"Adding a plugin runs its code on this throwaway demo — do it only with code you are willing to run.": "Ein Plugin hinzuzufügen führt seinen Code auf dieser Wegwerf-Demo aus — nur mit Code, dem Sie vertrauen.",
		"Version":                              "Version",
