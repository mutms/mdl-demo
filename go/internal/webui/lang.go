...
var messages = map[string]map[string]string{
	"cs": {
		...
		"Find versions":                     "Najít verze",
		"Install plugin":                    "Nainstalovat plugin",
		"Back up first, so I can undo this": "Nejprve zálohovat, abych to mohl vrátit zpět",
		"tag":                               "tag",
		...
		"The community plugin catalogue from camp-registry.org. Search, then test one in this demo site.": "Komunitní katalog pluginů z camp-registry.org. Vyhledejte a otestujte plugin na těchto demo stránkách.",
		...
		"Data from the camp registry": "Data z registru Camp",
	},
	"de": {
		...
		"Find versions":                     "Versionen suchen",
		"Install plugin":                    "Plugin installieren",
		"Back up first, so I can undo this": "Zuerst sichern, damit ich es rückgängig machen kann",
		"tag":                               "Tag",
		...
		"The community plugin catalogue from camp-registry.org. Search, then test one in this demo site.": "Der Community-Plugin-Katalog von camp-registry.org. Suchen und ein Plugin auf dieser Demo-Website testen.",
		...
		"Data from the camp registry": "Daten aus dem Camp-Registry",
	},
}
