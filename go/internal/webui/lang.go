...
var messages = map[string]map[string]string{
	"cs": {
		...
		"Keep current code (fast — no re-download)": "Ponechat stávající kód (rychlé – bez stahování)",
		"Backups":                         "Zálohy",
		"File":                            "Soubor",
		"Created":                         "Vytvořeno",
		"Size":                            "Velikost",
	...
	"de": {
		...
		"Keep current code (fast — no re-download)": "Aktuellen Code behalten (schnell – kein erneuter Download)",
		"Backups":                         "Sicherungen",
		"File":                            "Datei",
		"Created":                         "Erstellt",
		"Size":                            "Größe",
