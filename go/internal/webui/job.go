...
func (j *job) startPullUpdates(backupFirst bool, version string) bool {
	return j.start("update", "", "", func(logf execx.Logf) error {
		return site.PullUpdates(logf, backupFirst, version)
	})
}
